...
// checks if the GridVOControllerUserAppVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVOControllerUserAppVO{}

// GridVOControllerUserAppVO struct for GridVOControllerUserAppVO
type GridVOControllerUserAppVO struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []ControllerUserAppVO `json:"data,omitempty"`
...
func NewGridVOControllerUserAppVO() *GridVOControllerUserAppVO {
	this := GridVOControllerUserAppVO{}
	return &this
}
...
// SetData gets a reference to the given []ControllerUserAppVO and assigns it to the Data field.
...
func (o GridVOControllerUserAppVO) MarshalJSON() ([]byte, error) {
...
func (o GridVOControllerUserAppVO) ToMap() (map[string]interface{}, error) {
...
type NullableGridVOControllerUserAppVO struct {
	value *GridVOControllerUserAppVO
	isSet bool
}

func (v NullableGridVOControllerUserAppVO) Get() *GridVOControllerUserAppVO {
	return v.value
}

func (v *NullableGridVOControllerUserAppVO) Set(val *GridVOControllerUserAppVO) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVOControllerUserAppVO) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVOControllerUserAppVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVOControllerUserAppVO(val *GridVOControllerUserAppVO) *NullableGridVOControllerUserAppVO {
	return &NullableGridVOControllerUserAppVO{value: val, isSet: true}
}

func (v NullableGridVOControllerUserAppVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVOControllerUserAppVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
