...
// checks if the VpnUserOpenApiGridVOVpnUserInfoVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnUserOpenApiGridVOVpnUserInfoVO{}

// VpnUserOpenApiGridVOVpnUserInfoVO struct for VpnUserOpenApiGridVOVpnUserInfoVO
type VpnUserOpenApiGridVOVpnUserInfoVO struct {
	// Current page number.
...
func NewVpnUserOpenApiGridVOVpnUserInfoVO() *VpnUserOpenApiGridVOVpnUserInfoVO {
	this := VpnUserOpenApiGridVOVpnUserInfoVO{}
	return &this
}
...
func (o VpnUserOpenApiGridVOVpnUserInfoVO) MarshalJSON() ([]byte, error) {
...
func (o VpnUserOpenApiGridVOVpnUserInfoVO) ToMap() (map[string]interface{}, error) {
...
type NullableVpnUserOpenApiGridVOVpnUserInfoVO struct {
	value *VpnUserOpenApiGridVOVpnUserInfoVO
	isSet bool
}

func (v NullableVpnUserOpenApiGridVOVpnUserInfoVO) Get() *VpnUserOpenApiGridVOVpnUserInfoVO {
	return v.value
}

func (v *NullableVpnUserOpenApiGridVOVpnUserInfoVO) Set(val *VpnUserOpenApiGridVOVpnUserInfoVO) {
	v.value = val
	v.isSet = true
}

func (v NullableVpnUserOpenApiGridVOVpnUserInfoVO) IsSet() bool {
	return v.isSet
}

func (v *NullableVpnUserOpenApiGridVOVpnUserInfoVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpnUserOpenApiGridVOVpnUserInfoVO(val *VpnUserOpenApiGridVOVpnUserInfoVO) *NullableVpnUserOpenApiGridVOVpnUserInfoVO {
	return &NullableVpnUserOpenApiGridVOVpnUserInfoVO{value: val, isSet: true}
}

func (v NullableVpnUserOpenApiGridVOVpnUserInfoVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpnUserOpenApiGridVOVpnUserInfoVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
