...
// checks if the GridVOUpgradeLogOpenApiInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVOUpgradeLogOpenApiInfo{}

// GridVOUpgradeLogOpenApiInfo struct for GridVOUpgradeLogOpenApiInfo
type GridVOUpgradeLogOpenApiInfo struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []UpgradeLogOpenApiInfo `json:"data,omitempty"`
...
func NewGridVOUpgradeLogOpenApiInfo() *GridVOUpgradeLogOpenApiInfo {
	this := GridVOUpgradeLogOpenApiInfo{}
	return &this
}
...
// SetData gets a reference to the given []UpgradeLogOpenApiInfo and assigns it to the Data field.
...
func (o GridVOUpgradeLogOpenApiInfo) MarshalJSON() ([]byte, error) {
...
func (o GridVOUpgradeLogOpenApiInfo) ToMap() (map[string]interface{}, error) {
...
type NullableGridVOUpgradeLogOpenApiInfo struct {
	value *GridVOUpgradeLogOpenApiInfo
	isSet bool
}

func (v NullableGridVOUpgradeLogOpenApiInfo) Get() *GridVOUpgradeLogOpenApiInfo {
	return v.value
}

func (v *NullableGridVOUpgradeLogOpenApiInfo) Set(val *GridVOUpgradeLogOpenApiInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVOUpgradeLogOpenApiInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVOUpgradeLogOpenApiInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVOUpgradeLogOpenApiInfo(val *GridVOUpgradeLogOpenApiInfo) *NullableGridVOUpgradeLogOpenApiInfo {
	return &NullableGridVOUpgradeLogOpenApiInfo{value: val, isSet: true}
}

func (v NullableGridVOUpgradeLogOpenApiInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVOUpgradeLogOpenApiInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
