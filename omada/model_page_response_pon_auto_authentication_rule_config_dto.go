...
// checks if the PageResponsePonAutoAuthenticationRuleConfigDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageResponsePonAutoAuthenticationRuleConfigDTO{}

// PageResponsePonAutoAuthenticationRuleConfigDTO struct for PageResponsePonAutoAuthenticationRuleConfigDTO
type PageResponsePonAutoAuthenticationRuleConfigDTO struct {
	// Content
	Content []PonAutoAuthenticationRuleConfigDTO `json:"content,omitempty"`
...
func NewPageResponsePonAutoAuthenticationRuleConfigDTO() *PageResponsePonAutoAuthenticationRuleConfigDTO {
	this := PageResponsePonAutoAuthenticationRuleConfigDTO{}
	return &this
}
...
// SetContent gets a reference to the given []PonAutoAuthenticationRuleConfigDTO and assigns it to the Content field.
...
func (o PageResponsePonAutoAuthenticationRuleConfigDTO) MarshalJSON() ([]byte, error) {
...
func (o PageResponsePonAutoAuthenticationRuleConfigDTO) ToMap() (map[string]interface{}, error) {
...
type NullablePageResponsePonAutoAuthenticationRuleConfigDTO struct {
	value *PageResponsePonAutoAuthenticationRuleConfigDTO
	isSet bool
}

func (v NullablePageResponsePonAutoAuthenticationRuleConfigDTO) Get() *PageResponsePonAutoAuthenticationRuleConfigDTO {
	return v.value
}

func (v *NullablePageResponsePonAutoAuthenticationRuleConfigDTO) Set(val *PageResponsePonAutoAuthenticationRuleConfigDTO) {
	v.value = val
	v.isSet = true
}

func (v NullablePageResponsePonAutoAuthenticationRuleConfigDTO) IsSet() bool {
	return v.isSet
}

func (v *NullablePageResponsePonAutoAuthenticationRuleConfigDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageResponsePonAutoAuthenticationRuleConfigDTO(val *PageResponsePonAutoAuthenticationRuleConfigDTO) *NullablePageResponsePonAutoAuthenticationRuleConfigDTO {
	return &NullablePageResponsePonAutoAuthenticationRuleConfigDTO{value: val, isSet: true}
}

func (v NullablePageResponsePonAutoAuthenticationRuleConfigDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageResponsePonAutoAuthenticationRuleConfigDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
