...
// checks if the PlanUpgradeCreateInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlanUpgradeCreateInfo{}

// PlanUpgradeCreateInfo struct for PlanUpgradeCreateInfo
type PlanUpgradeCreateInfo struct {
	...
	ModelList []PlanUpgradeSelectedModel `json:"modelList"`
...
type _PlanUpgradeCreateInfo PlanUpgradeCreateInfo
...
func (o *PlanUpgradeCreateInfo) GetModelList() []PlanUpgradeSelectedModel {
	if o == nil {
		var ret []PlanUpgradeSelectedModel
		return ret
	}
...
func (o PlanUpgradeCreateInfo) MarshalJSON() ([]byte, error) {
...
func (o PlanUpgradeCreateInfo) ToMap() (map[string]interface{}, error) {
...
func (o *PlanUpgradeCreateInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varPlanUpgradeCreateInfo := _PlanUpgradeCreateInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPlanUpgradeCreateInfo)

	if err != nil {
		return err
	}

	*o = PlanUpgradeCreateInfo(varPlanUpgradeCreateInfo)

	return err
}

type NullablePlanUpgradeCreateInfo struct {
	value *PlanUpgradeCreateInfo
	isSet bool
}

func (v NullablePlanUpgradeCreateInfo) Get() *PlanUpgradeCreateInfo {
	return v.value
}

func (v *NullablePlanUpgradeCreateInfo) Set(val *PlanUpgradeCreateInfo) {
	v.value = val
	v.isSet = true
}

func (v NullablePlanUpgradeCreateInfo) IsSet() bool {
	return v.isSet
}

func (v *NullablePlanUpgradeCreateInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlanUpgradeCreateInfo(val *PlanUpgradeCreateInfo) *NullablePlanUpgradeCreateInfo {
	return &NullablePlanUpgradeCreateInfo{value: val, isSet: true}
}

func (v NullablePlanUpgradeCreateInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlanUpgradeCreateInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
