...
// checks if the GridVOSsidDeviceOpenApiVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVOSsidDeviceOpenApiVO{}

// GridVOSsidDeviceOpenApiVO struct for GridVOSsidDeviceOpenApiVO
type GridVOSsidDeviceOpenApiVO struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []SsidDeviceOpenApiVO `json:"data,omitempty"`
...
func NewGridVOSsidDeviceOpenApiVO() *GridVOSsidDeviceOpenApiVO {
	this := GridVOSsidDeviceOpenApiVO{}
	return &this
}
...
// SetData gets a reference to the given []SsidDeviceOpenApiVO and assigns it to the Data field.
...
func (o GridVOSsidDeviceOpenApiVO) MarshalJSON() ([]byte, error) {
...
func (o GridVOSsidDeviceOpenApiVO) ToMap() (map[string]interface{}, error) {
...
type NullableGridVOSsidDeviceOpenApiVO struct {
	value *GridVOSsidDeviceOpenApiVO
	isSet bool
}

func (v NullableGridVOSsidDeviceOpenApiVO) Get() *GridVOSsidDeviceOpenApiVO {
	return v.value
}

func (v *NullableGridVOSsidDeviceOpenApiVO) Set(val *GridVOSsidDeviceOpenApiVO) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVOSsidDeviceOpenApiVO) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVOSsidDeviceOpenApiVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVOSsidDeviceOpenApiVO(val *GridVOSsidDeviceOpenApiVO) *NullableGridVOSsidDeviceOpenApiVO {
	return &NullableGridVOSsidDeviceOpenApiVO{value: val, isSet: true}
}

func (v NullableGridVOSsidDeviceOpenApiVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVOSsidDeviceOpenApiVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
