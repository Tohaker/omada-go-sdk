...
// checks if the DhcpSnoopVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpSnoopVO{}

// DhcpSnoopVO struct for DhcpSnoopVO
type DhcpSnoopVO struct {
	...
	// The primary id of the dhcp snoop.
	Id *string `json:"id,omitempty"`
	// The mac of the general device.
	Mac *string `json:"mac,omitempty"`
	// The name of the dhcp snoop.
	Name *string `json:"name,omitempty"`
	// The id of the omada the dhcp snoop belongs to.
	...
	// The id of the site the dhcp snoop belongs to.
...
func (o DhcpSnoopVO) MarshalJSON() ([]byte, error) {
...
func (o DhcpSnoopVO) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpSnoopVO struct {
	value *DhcpSnoopVO
	isSet bool
}

func (v NullableDhcpSnoopVO) Get() *DhcpSnoopVO {
	return v.value
}

func (v *NullableDhcpSnoopVO) Set(val *DhcpSnoopVO) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpSnoopVO) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpSnoopVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpSnoopVO(val *DhcpSnoopVO) *NullableDhcpSnoopVO {
	return &NullableDhcpSnoopVO{value: val, isSet: true}
}

func (v NullableDhcpSnoopVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpSnoopVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
