...
// checks if the GridVOMonitorDevice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVOMonitorDevice{}

// GridVOMonitorDevice struct for GridVOMonitorDevice
type GridVOMonitorDevice struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []MonitorDevice `json:"data,omitempty"`
...
// SetData gets a reference to the given []MonitorDevice and assigns it to the Data field.
...
func (o GridVOMonitorDevice) MarshalJSON() ([]byte, error) {
...
func (o GridVOMonitorDevice) ToMap() (map[string]interface{}, error) {
...
type NullableGridVOMonitorDevice struct {
	value *GridVOMonitorDevice
	isSet bool
}

func (v NullableGridVOMonitorDevice) Get() *GridVOMonitorDevice {
	return v.value
}

func (v *NullableGridVOMonitorDevice) Set(val *GridVOMonitorDevice) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVOMonitorDevice) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVOMonitorDevice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVOMonitorDevice(val *GridVOMonitorDevice) *NullableGridVOMonitorDevice {
	return &NullableGridVOMonitorDevice{value: val, isSet: true}
}

func (v NullableGridVOMonitorDevice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVOMonitorDevice) UnmarshalJSON(src []byte) error {
	v.isSet = true
