...
// checks if the GridVORestrictionEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVORestrictionEntity{}

// GridVORestrictionEntity struct for GridVORestrictionEntity
type GridVORestrictionEntity struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []RestrictionEntity `json:"data,omitempty"`
...
// SetData gets a reference to the given []RestrictionEntity and assigns it to the Data field.
...
func (o GridVORestrictionEntity) MarshalJSON() ([]byte, error) {
...
func (o GridVORestrictionEntity) ToMap() (map[string]interface{}, error) {
...
type NullableGridVORestrictionEntity struct {
	value *GridVORestrictionEntity
	isSet bool
}

func (v NullableGridVORestrictionEntity) Get() *GridVORestrictionEntity {
	return v.value
}

func (v *NullableGridVORestrictionEntity) Set(val *GridVORestrictionEntity) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVORestrictionEntity) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVORestrictionEntity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVORestrictionEntity(val *GridVORestrictionEntity) *NullableGridVORestrictionEntity {
	return &NullableGridVORestrictionEntity{value: val, isSet: true}
}

func (v NullableGridVORestrictionEntity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVORestrictionEntity) UnmarshalJSON(src []byte) error {
	v.isSet = true
