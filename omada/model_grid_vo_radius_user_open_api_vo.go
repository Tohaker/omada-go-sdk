...
// checks if the GridVORadiusUserOpenApiVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVORadiusUserOpenApiVO{}

// GridVORadiusUserOpenApiVO struct for GridVORadiusUserOpenApiVO
type GridVORadiusUserOpenApiVO struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []RadiusUserOpenApiVO `json:"data,omitempty"`
...
func NewGridVORadiusUserOpenApiVO() *GridVORadiusUserOpenApiVO {
	this := GridVORadiusUserOpenApiVO{}
	return &this
}
...
// SetData gets a reference to the given []RadiusUserOpenApiVO and assigns it to the Data field.
...
func (o GridVORadiusUserOpenApiVO) MarshalJSON() ([]byte, error) {
...
func (o GridVORadiusUserOpenApiVO) ToMap() (map[string]interface{}, error) {
...
type NullableGridVORadiusUserOpenApiVO struct {
	value *GridVORadiusUserOpenApiVO
	isSet bool
}

func (v NullableGridVORadiusUserOpenApiVO) Get() *GridVORadiusUserOpenApiVO {
	return v.value
}

func (v *NullableGridVORadiusUserOpenApiVO) Set(val *GridVORadiusUserOpenApiVO) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVORadiusUserOpenApiVO) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVORadiusUserOpenApiVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVORadiusUserOpenApiVO(val *GridVORadiusUserOpenApiVO) *NullableGridVORadiusUserOpenApiVO {
	return &NullableGridVORadiusUserOpenApiVO{value: val, isSet: true}
}

func (v NullableGridVORadiusUserOpenApiVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVORadiusUserOpenApiVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
