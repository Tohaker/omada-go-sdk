...
// checks if the DeviceResponseBodyLineProfileDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceResponseBodyLineProfileDTO{}

// DeviceResponseBodyLineProfileDTO struct for DeviceResponseBodyLineProfileDTO
type DeviceResponseBodyLineProfileDTO struct {
	Data *LineProfileDTO `json:"data,omitempty"`
...
func NewDeviceResponseBodyLineProfileDTO() *DeviceResponseBodyLineProfileDTO {
	this := DeviceResponseBodyLineProfileDTO{}
	return &this
}
...
// SetData gets a reference to the given LineProfileDTO and assigns it to the Data field.
...
func (o DeviceResponseBodyLineProfileDTO) MarshalJSON() ([]byte, error) {
...
func (o DeviceResponseBodyLineProfileDTO) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceResponseBodyLineProfileDTO struct {
	value *DeviceResponseBodyLineProfileDTO
	isSet bool
}

func (v NullableDeviceResponseBodyLineProfileDTO) Get() *DeviceResponseBodyLineProfileDTO {
	return v.value
}

func (v *NullableDeviceResponseBodyLineProfileDTO) Set(val *DeviceResponseBodyLineProfileDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceResponseBodyLineProfileDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceResponseBodyLineProfileDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceResponseBodyLineProfileDTO(val *DeviceResponseBodyLineProfileDTO) *NullableDeviceResponseBodyLineProfileDTO {
	return &NullableDeviceResponseBodyLineProfileDTO{value: val, isSet: true}
}

func (v NullableDeviceResponseBodyLineProfileDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceResponseBodyLineProfileDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
