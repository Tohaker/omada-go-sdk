...
// checks if the OspfInterfaceOpenApiVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OspfInterfaceOpenApiVO{}

// OspfInterfaceOpenApiVO struct for OspfInterfaceOpenApiVO
...
type _OspfInterfaceOpenApiVO OspfInterfaceOpenApiVO
...
func (o OspfInterfaceOpenApiVO) MarshalJSON() ([]byte, error) {
...
func (o OspfInterfaceOpenApiVO) ToMap() (map[string]interface{}, error) {
...
func (o *OspfInterfaceOpenApiVO) UnmarshalJSON(data []byte) (err error) {
	...
	varOspfInterfaceOpenApiVO := _OspfInterfaceOpenApiVO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOspfInterfaceOpenApiVO)

	if err != nil {
		return err
	}

	*o = OspfInterfaceOpenApiVO(varOspfInterfaceOpenApiVO)

	return err
}

type NullableOspfInterfaceOpenApiVO struct {
	value *OspfInterfaceOpenApiVO
	isSet bool
}

func (v NullableOspfInterfaceOpenApiVO) Get() *OspfInterfaceOpenApiVO {
	return v.value
}

func (v *NullableOspfInterfaceOpenApiVO) Set(val *OspfInterfaceOpenApiVO) {
	v.value = val
	v.isSet = true
}

func (v NullableOspfInterfaceOpenApiVO) IsSet() bool {
	return v.isSet
}

func (v *NullableOspfInterfaceOpenApiVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOspfInterfaceOpenApiVO(val *OspfInterfaceOpenApiVO) *NullableOspfInterfaceOpenApiVO {
	return &NullableOspfInterfaceOpenApiVO{value: val, isSet: true}
}

func (v NullableOspfInterfaceOpenApiVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOspfInterfaceOpenApiVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
