...
// checks if the ModifyMailServerOpenApiVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModifyMailServerOpenApiVO{}

// ModifyMailServerOpenApiVO struct for ModifyMailServerOpenApiVO
...
type _ModifyMailServerOpenApiVO ModifyMailServerOpenApiVO
...
func NewModifyMailServerOpenApiVO(authEnable bool, port int32, smtpServer string, sslEnable bool) *ModifyMailServerOpenApiVO {
	this := ModifyMailServerOpenApiVO{}
...
func (o ModifyMailServerOpenApiVO) MarshalJSON() ([]byte, error) {
...
func (o ModifyMailServerOpenApiVO) ToMap() (map[string]interface{}, error) {
...
func (o *ModifyMailServerOpenApiVO) UnmarshalJSON(data []byte) (err error) {
	...
	varModifyMailServerOpenApiVO := _ModifyMailServerOpenApiVO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varModifyMailServerOpenApiVO)

	if err != nil {
		return err
	}

	*o = ModifyMailServerOpenApiVO(varModifyMailServerOpenApiVO)

	return err
}

type NullableModifyMailServerOpenApiVO struct {
	value *ModifyMailServerOpenApiVO
	isSet bool
}

func (v NullableModifyMailServerOpenApiVO) Get() *ModifyMailServerOpenApiVO {
	return v.value
}

func (v *NullableModifyMailServerOpenApiVO) Set(val *ModifyMailServerOpenApiVO) {
	v.value = val
	v.isSet = true
}

func (v NullableModifyMailServerOpenApiVO) IsSet() bool {
	return v.isSet
}

func (v *NullableModifyMailServerOpenApiVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModifyMailServerOpenApiVO(val *ModifyMailServerOpenApiVO) *NullableModifyMailServerOpenApiVO {
	return &NullableModifyMailServerOpenApiVO{value: val, isSet: true}
}

func (v NullableModifyMailServerOpenApiVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModifyMailServerOpenApiVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
