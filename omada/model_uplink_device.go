...
// checks if the UplinkDevice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UplinkDevice{}
...
func (o UplinkDevice) MarshalJSON() ([]byte, error) {
...
func (o UplinkDevice) ToMap() (map[string]interface{}, error) {
...
type NullableUplinkDevice struct {
	value *UplinkDevice
	isSet bool
}

func (v NullableUplinkDevice) Get() *UplinkDevice {
	return v.value
}

func (v *NullableUplinkDevice) Set(val *UplinkDevice) {
	v.value = val
	v.isSet = true
}

func (v NullableUplinkDevice) IsSet() bool {
	return v.isSet
}

func (v *NullableUplinkDevice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUplinkDevice(val *UplinkDevice) *NullableUplinkDevice {
	return &NullableUplinkDevice{value: val, isSet: true}
}

func (v NullableUplinkDevice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUplinkDevice) UnmarshalJSON(src []byte) error {
	v.isSet = true
