...
// checks if the LineProfileListQueryDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LineProfileListQueryDTO{}

// LineProfileListQueryDTO struct for LineProfileListQueryDTO
type LineProfileListQueryDTO struct {
	// Search fields
...
func (o LineProfileListQueryDTO) MarshalJSON() ([]byte, error) {
...
func (o LineProfileListQueryDTO) ToMap() (map[string]interface{}, error) {
...
type NullableLineProfileListQueryDTO struct {
	value *LineProfileListQueryDTO
	isSet bool
}

func (v NullableLineProfileListQueryDTO) Get() *LineProfileListQueryDTO {
	return v.value
}

func (v *NullableLineProfileListQueryDTO) Set(val *LineProfileListQueryDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableLineProfileListQueryDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableLineProfileListQueryDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLineProfileListQueryDTO(val *LineProfileListQueryDTO) *NullableLineProfileListQueryDTO {
	return &NullableLineProfileListQueryDTO{value: val, isSet: true}
}

func (v NullableLineProfileListQueryDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLineProfileListQueryDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
