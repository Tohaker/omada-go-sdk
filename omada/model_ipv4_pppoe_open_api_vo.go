...
// checks if the Ipv4PppoeOpenApiVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Ipv4PppoeOpenApiVO{}
...
type _Ipv4PppoeOpenApiVO Ipv4PppoeOpenApiVO
...
func (o Ipv4PppoeOpenApiVO) MarshalJSON() ([]byte, error) {
...
func (o Ipv4PppoeOpenApiVO) ToMap() (map[string]interface{}, error) {
...
func (o *Ipv4PppoeOpenApiVO) UnmarshalJSON(data []byte) (err error) {
	...
	varIpv4PppoeOpenApiVO := _Ipv4PppoeOpenApiVO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIpv4PppoeOpenApiVO)

	if err != nil {
		return err
	}

	*o = Ipv4PppoeOpenApiVO(varIpv4PppoeOpenApiVO)

	return err
}

type NullableIpv4PppoeOpenApiVO struct {
	value *Ipv4PppoeOpenApiVO
	isSet bool
}

func (v NullableIpv4PppoeOpenApiVO) Get() *Ipv4PppoeOpenApiVO {
	return v.value
}

func (v *NullableIpv4PppoeOpenApiVO) Set(val *Ipv4PppoeOpenApiVO) {
	v.value = val
	v.isSet = true
}

func (v NullableIpv4PppoeOpenApiVO) IsSet() bool {
	return v.isSet
}

func (v *NullableIpv4PppoeOpenApiVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpv4PppoeOpenApiVO(val *Ipv4PppoeOpenApiVO) *NullableIpv4PppoeOpenApiVO {
	return &NullableIpv4PppoeOpenApiVO{value: val, isSet: true}
}

func (v NullableIpv4PppoeOpenApiVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpv4PppoeOpenApiVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
