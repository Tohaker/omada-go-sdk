...
// checks if the GetVpnResponseGridVOVpnTunnelRemoteStatusVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetVpnResponseGridVOVpnTunnelRemoteStatusVO{}

// GetVpnResponseGridVOVpnTunnelRemoteStatusVO struct for GetVpnResponseGridVOVpnTunnelRemoteStatusVO
type GetVpnResponseGridVOVpnTunnelRemoteStatusVO struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []VpnTunnelRemoteStatusVO `json:"data,omitempty"`
...
func NewGetVpnResponseGridVOVpnTunnelRemoteStatusVO() *GetVpnResponseGridVOVpnTunnelRemoteStatusVO {
	this := GetVpnResponseGridVOVpnTunnelRemoteStatusVO{}
	return &this
}
...
func (o *GetVpnResponseGridVOVpnTunnelRemoteStatusVO) GetData() []VpnTunnelRemoteStatusVO {
	if o == nil || IsNil(o.Data) {
		var ret []VpnTunnelRemoteStatusVO
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []VpnTunnelRemoteStatusVO and assigns it to the Data field.
...
func (o GetVpnResponseGridVOVpnTunnelRemoteStatusVO) MarshalJSON() ([]byte, error) {
...
func (o GetVpnResponseGridVOVpnTunnelRemoteStatusVO) ToMap() (map[string]interface{}, error) {
...
type NullableGetVpnResponseGridVOVpnTunnelRemoteStatusVO struct {
	value *GetVpnResponseGridVOVpnTunnelRemoteStatusVO
	isSet bool
}

func (v NullableGetVpnResponseGridVOVpnTunnelRemoteStatusVO) Get() *GetVpnResponseGridVOVpnTunnelRemoteStatusVO {
	return v.value
}

func (v *NullableGetVpnResponseGridVOVpnTunnelRemoteStatusVO) Set(val *GetVpnResponseGridVOVpnTunnelRemoteStatusVO) {
	v.value = val
	v.isSet = true
}

func (v NullableGetVpnResponseGridVOVpnTunnelRemoteStatusVO) IsSet() bool {
	return v.isSet
}

func (v *NullableGetVpnResponseGridVOVpnTunnelRemoteStatusVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetVpnResponseGridVOVpnTunnelRemoteStatusVO(val *GetVpnResponseGridVOVpnTunnelRemoteStatusVO) *NullableGetVpnResponseGridVOVpnTunnelRemoteStatusVO {
	return &NullableGetVpnResponseGridVOVpnTunnelRemoteStatusVO{value: val, isSet: true}
}

func (v NullableGetVpnResponseGridVOVpnTunnelRemoteStatusVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetVpnResponseGridVOVpnTunnelRemoteStatusVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
