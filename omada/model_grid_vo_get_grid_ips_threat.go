...
// checks if the GridVOGetGridIpsThreat type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVOGetGridIpsThreat{}

// GridVOGetGridIpsThreat struct for GridVOGetGridIpsThreat
type GridVOGetGridIpsThreat struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []GetGridIpsThreat `json:"data,omitempty"`
...
// SetData gets a reference to the given []GetGridIpsThreat and assigns it to the Data field.
...
func (o GridVOGetGridIpsThreat) MarshalJSON() ([]byte, error) {
...
func (o GridVOGetGridIpsThreat) ToMap() (map[string]interface{}, error) {
...
type NullableGridVOGetGridIpsThreat struct {
	value *GridVOGetGridIpsThreat
	isSet bool
}

func (v NullableGridVOGetGridIpsThreat) Get() *GridVOGetGridIpsThreat {
	return v.value
}

func (v *NullableGridVOGetGridIpsThreat) Set(val *GridVOGetGridIpsThreat) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVOGetGridIpsThreat) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVOGetGridIpsThreat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVOGetGridIpsThreat(val *GridVOGetGridIpsThreat) *NullableGridVOGetGridIpsThreat {
	return &NullableGridVOGetGridIpsThreat{value: val, isSet: true}
}

func (v NullableGridVOGetGridIpsThreat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVOGetGridIpsThreat) UnmarshalJSON(src []byte) error {
	v.isSet = true
