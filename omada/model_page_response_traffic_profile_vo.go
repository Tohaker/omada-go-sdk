...
// checks if the PageResponseTrafficProfileVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageResponseTrafficProfileVO{}

// PageResponseTrafficProfileVO struct for PageResponseTrafficProfileVO
type PageResponseTrafficProfileVO struct {
	// Content
	Content []TrafficProfileVO `json:"content,omitempty"`
...
func NewPageResponseTrafficProfileVO() *PageResponseTrafficProfileVO {
	this := PageResponseTrafficProfileVO{}
	return &this
}
...
// SetContent gets a reference to the given []TrafficProfileVO and assigns it to the Content field.
...
func (o PageResponseTrafficProfileVO) MarshalJSON() ([]byte, error) {
...
func (o PageResponseTrafficProfileVO) ToMap() (map[string]interface{}, error) {
...
type NullablePageResponseTrafficProfileVO struct {
	value *PageResponseTrafficProfileVO
	isSet bool
}

func (v NullablePageResponseTrafficProfileVO) Get() *PageResponseTrafficProfileVO {
	return v.value
}

func (v *NullablePageResponseTrafficProfileVO) Set(val *PageResponseTrafficProfileVO) {
	v.value = val
	v.isSet = true
}

func (v NullablePageResponseTrafficProfileVO) IsSet() bool {
	return v.isSet
}

func (v *NullablePageResponseTrafficProfileVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageResponseTrafficProfileVO(val *PageResponseTrafficProfileVO) *NullablePageResponseTrafficProfileVO {
	return &NullablePageResponseTrafficProfileVO{value: val, isSet: true}
}

func (v NullablePageResponseTrafficProfileVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageResponseTrafficProfileVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
