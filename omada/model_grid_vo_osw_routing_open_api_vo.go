...
// checks if the GridVOOswRoutingOpenApiVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVOOswRoutingOpenApiVO{}

// GridVOOswRoutingOpenApiVO struct for GridVOOswRoutingOpenApiVO
type GridVOOswRoutingOpenApiVO struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []OswRoutingOpenApiVO `json:"data,omitempty"`
...
func NewGridVOOswRoutingOpenApiVO() *GridVOOswRoutingOpenApiVO {
	this := GridVOOswRoutingOpenApiVO{}
	return &this
}
...
// SetData gets a reference to the given []OswRoutingOpenApiVO and assigns it to the Data field.
...
func (o GridVOOswRoutingOpenApiVO) MarshalJSON() ([]byte, error) {
...
func (o GridVOOswRoutingOpenApiVO) ToMap() (map[string]interface{}, error) {
...
type NullableGridVOOswRoutingOpenApiVO struct {
	value *GridVOOswRoutingOpenApiVO
	isSet bool
}

func (v NullableGridVOOswRoutingOpenApiVO) Get() *GridVOOswRoutingOpenApiVO {
	return v.value
}

func (v *NullableGridVOOswRoutingOpenApiVO) Set(val *GridVOOswRoutingOpenApiVO) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVOOswRoutingOpenApiVO) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVOOswRoutingOpenApiVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVOOswRoutingOpenApiVO(val *GridVOOswRoutingOpenApiVO) *NullableGridVOOswRoutingOpenApiVO {
	return &NullableGridVOOswRoutingOpenApiVO{value: val, isSet: true}
}

func (v NullableGridVOOswRoutingOpenApiVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVOOswRoutingOpenApiVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
