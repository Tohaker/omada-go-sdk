...
// checks if the StackPortSettingVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StackPortSettingVO{}

// StackPortSettingVO struct for StackPortSettingVO
type StackPortSettingVO struct {
...
func (o StackPortSettingVO) MarshalJSON() ([]byte, error) {
...
func (o StackPortSettingVO) ToMap() (map[string]interface{}, error) {
...
type NullableStackPortSettingVO struct {
	value *StackPortSettingVO
	isSet bool
}

func (v NullableStackPortSettingVO) Get() *StackPortSettingVO {
	return v.value
}

func (v *NullableStackPortSettingVO) Set(val *StackPortSettingVO) {
	v.value = val
	v.isSet = true
}

func (v NullableStackPortSettingVO) IsSet() bool {
	return v.isSet
}

func (v *NullableStackPortSettingVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStackPortSettingVO(val *StackPortSettingVO) *NullableStackPortSettingVO {
	return &NullableStackPortSettingVO{value: val, isSet: true}
}

func (v NullableStackPortSettingVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStackPortSettingVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
