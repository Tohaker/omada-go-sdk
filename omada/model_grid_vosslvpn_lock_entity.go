...
// checks if the GridVOSSLVPNLockEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVOSSLVPNLockEntity{}

// GridVOSSLVPNLockEntity struct for GridVOSSLVPNLockEntity
...
// SetData gets a reference to the given []SSLVPNLockEntity and assigns it to the Data field.
...
func (o GridVOSSLVPNLockEntity) MarshalJSON() ([]byte, error) {
...
func (o GridVOSSLVPNLockEntity) ToMap() (map[string]interface{}, error) {
...
type NullableGridVOSSLVPNLockEntity struct {
	value *GridVOSSLVPNLockEntity
	isSet bool
}

func (v NullableGridVOSSLVPNLockEntity) Get() *GridVOSSLVPNLockEntity {
	return v.value
}

func (v *NullableGridVOSSLVPNLockEntity) Set(val *GridVOSSLVPNLockEntity) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVOSSLVPNLockEntity) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVOSSLVPNLockEntity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVOSSLVPNLockEntity(val *GridVOSSLVPNLockEntity) *NullableGridVOSSLVPNLockEntity {
	return &NullableGridVOSSLVPNLockEntity{value: val, isSet: true}
}

func (v NullableGridVOSSLVPNLockEntity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVOSSLVPNLockEntity) UnmarshalJSON(src []byte) error {
	v.isSet = true
