...
// checks if the GridVOAuditLogOpenApiVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVOAuditLogOpenApiVO{}

// GridVOAuditLogOpenApiVO struct for GridVOAuditLogOpenApiVO
type GridVOAuditLogOpenApiVO struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []AuditLogOpenApiVO `json:"data,omitempty"`
...
// SetData gets a reference to the given []AuditLogOpenApiVO and assigns it to the Data field.
...
func (o GridVOAuditLogOpenApiVO) MarshalJSON() ([]byte, error) {
...
func (o GridVOAuditLogOpenApiVO) ToMap() (map[string]interface{}, error) {
...
type NullableGridVOAuditLogOpenApiVO struct {
	value *GridVOAuditLogOpenApiVO
	isSet bool
}

func (v NullableGridVOAuditLogOpenApiVO) Get() *GridVOAuditLogOpenApiVO {
	return v.value
}

func (v *NullableGridVOAuditLogOpenApiVO) Set(val *GridVOAuditLogOpenApiVO) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVOAuditLogOpenApiVO) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVOAuditLogOpenApiVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVOAuditLogOpenApiVO(val *GridVOAuditLogOpenApiVO) *NullableGridVOAuditLogOpenApiVO {
	return &NullableGridVOAuditLogOpenApiVO{value: val, isSet: true}
}

func (v NullableGridVOAuditLogOpenApiVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVOAuditLogOpenApiVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
