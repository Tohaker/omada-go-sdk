...
// checks if the IPsecFailoverConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IPsecFailoverConfiguration{}

// IPsecFailoverConfiguration struct for IPsecFailoverConfiguration
type IPsecFailoverConfiguration struct {
...
type _IPsecFailoverConfiguration IPsecFailoverConfiguration
...
func NewIPsecFailoverConfiguration(candidates []string, name string, primary string) *IPsecFailoverConfiguration {
	this := IPsecFailoverConfiguration{}
...
func (o IPsecFailoverConfiguration) MarshalJSON() ([]byte, error) {
...
func (o IPsecFailoverConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *IPsecFailoverConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	varIPsecFailoverConfiguration := _IPsecFailoverConfiguration{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIPsecFailoverConfiguration)

	if err != nil {
		return err
	}

	*o = IPsecFailoverConfiguration(varIPsecFailoverConfiguration)

	return err
}

type NullableIPsecFailoverConfiguration struct {
	value *IPsecFailoverConfiguration
	isSet bool
}

func (v NullableIPsecFailoverConfiguration) Get() *IPsecFailoverConfiguration {
	return v.value
}

func (v *NullableIPsecFailoverConfiguration) Set(val *IPsecFailoverConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableIPsecFailoverConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableIPsecFailoverConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIPsecFailoverConfiguration(val *IPsecFailoverConfiguration) *NullableIPsecFailoverConfiguration {
	return &NullableIPsecFailoverConfiguration{value: val, isSet: true}
}

func (v NullableIPsecFailoverConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIPsecFailoverConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
