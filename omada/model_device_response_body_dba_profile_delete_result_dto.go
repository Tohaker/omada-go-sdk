...
// checks if the DeviceResponseBodyDBAProfileDeleteResultDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceResponseBodyDBAProfileDeleteResultDTO{}

// DeviceResponseBodyDBAProfileDeleteResultDTO struct for DeviceResponseBodyDBAProfileDeleteResultDTO
type DeviceResponseBodyDBAProfileDeleteResultDTO struct {
	Data *DBAProfileDeleteResultDTO `json:"data,omitempty"`
...
func NewDeviceResponseBodyDBAProfileDeleteResultDTO() *DeviceResponseBodyDBAProfileDeleteResultDTO {
	this := DeviceResponseBodyDBAProfileDeleteResultDTO{}
	return &this
}
...
func (o *DeviceResponseBodyDBAProfileDeleteResultDTO) GetData() DBAProfileDeleteResultDTO {
	if o == nil || IsNil(o.Data) {
		var ret DBAProfileDeleteResultDTO
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given DBAProfileDeleteResultDTO and assigns it to the Data field.
...
func (o DeviceResponseBodyDBAProfileDeleteResultDTO) MarshalJSON() ([]byte, error) {
...
func (o DeviceResponseBodyDBAProfileDeleteResultDTO) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceResponseBodyDBAProfileDeleteResultDTO struct {
	value *DeviceResponseBodyDBAProfileDeleteResultDTO
	isSet bool
}

func (v NullableDeviceResponseBodyDBAProfileDeleteResultDTO) Get() *DeviceResponseBodyDBAProfileDeleteResultDTO {
	return v.value
}

func (v *NullableDeviceResponseBodyDBAProfileDeleteResultDTO) Set(val *DeviceResponseBodyDBAProfileDeleteResultDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceResponseBodyDBAProfileDeleteResultDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceResponseBodyDBAProfileDeleteResultDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceResponseBodyDBAProfileDeleteResultDTO(val *DeviceResponseBodyDBAProfileDeleteResultDTO) *NullableDeviceResponseBodyDBAProfileDeleteResultDTO {
	return &NullableDeviceResponseBodyDBAProfileDeleteResultDTO{value: val, isSet: true}
}

func (v NullableDeviceResponseBodyDBAProfileDeleteResultDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceResponseBodyDBAProfileDeleteResultDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
