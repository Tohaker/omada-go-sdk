...
// checks if the GridVOLanProfileInfoOpenApiVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVOLanProfileInfoOpenApiVO{}

// GridVOLanProfileInfoOpenApiVO struct for GridVOLanProfileInfoOpenApiVO
type GridVOLanProfileInfoOpenApiVO struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []LanProfileInfoOpenApiVO `json:"data,omitempty"`
...
func NewGridVOLanProfileInfoOpenApiVO() *GridVOLanProfileInfoOpenApiVO {
	this := GridVOLanProfileInfoOpenApiVO{}
	return &this
}
...
func (o *GridVOLanProfileInfoOpenApiVO) GetData() []LanProfileInfoOpenApiVO {
	if o == nil || IsNil(o.Data) {
		var ret []LanProfileInfoOpenApiVO
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []LanProfileInfoOpenApiVO and assigns it to the Data field.
...
func (o GridVOLanProfileInfoOpenApiVO) MarshalJSON() ([]byte, error) {
...
func (o GridVOLanProfileInfoOpenApiVO) ToMap() (map[string]interface{}, error) {
...
type NullableGridVOLanProfileInfoOpenApiVO struct {
	value *GridVOLanProfileInfoOpenApiVO
	isSet bool
}

func (v NullableGridVOLanProfileInfoOpenApiVO) Get() *GridVOLanProfileInfoOpenApiVO {
	return v.value
}

func (v *NullableGridVOLanProfileInfoOpenApiVO) Set(val *GridVOLanProfileInfoOpenApiVO) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVOLanProfileInfoOpenApiVO) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVOLanProfileInfoOpenApiVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVOLanProfileInfoOpenApiVO(val *GridVOLanProfileInfoOpenApiVO) *NullableGridVOLanProfileInfoOpenApiVO {
	return &NullableGridVOLanProfileInfoOpenApiVO{value: val, isSet: true}
}

func (v NullableGridVOLanProfileInfoOpenApiVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVOLanProfileInfoOpenApiVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
