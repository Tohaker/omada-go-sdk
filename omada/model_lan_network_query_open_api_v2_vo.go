...
// checks if the LanNetworkQueryOpenApiV2VO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LanNetworkQueryOpenApiV2VO{}
...
type LanNetworkQueryOpenApiV2VO struct {
	...
	DhcpSettingsVO *DhcpSettingInfo `json:"dhcpSettingsVO,omitempty"`
...
type _LanNetworkQueryOpenApiV2VO LanNetworkQueryOpenApiV2VO
...
func NewLanNetworkQueryOpenApiV2VO(igmpSnoopEnable bool, name string, purpose int32) *LanNetworkQueryOpenApiV2VO {
	this := LanNetworkQueryOpenApiV2VO{}
...
// SetDhcpSettingsVO gets a reference to the given DhcpSettingInfo and assigns it to the DhcpSettingsVO field.
...
func (o LanNetworkQueryOpenApiV2VO) MarshalJSON() ([]byte, error) {
...
func (o LanNetworkQueryOpenApiV2VO) ToMap() (map[string]interface{}, error) {
...
func (o *LanNetworkQueryOpenApiV2VO) UnmarshalJSON(data []byte) (err error) {
	...
	varLanNetworkQueryOpenApiV2VO := _LanNetworkQueryOpenApiV2VO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLanNetworkQueryOpenApiV2VO)

	if err != nil {
		return err
	}

	*o = LanNetworkQueryOpenApiV2VO(varLanNetworkQueryOpenApiV2VO)

	return err
}

type NullableLanNetworkQueryOpenApiV2VO struct {
	value *LanNetworkQueryOpenApiV2VO
	isSet bool
}

func (v NullableLanNetworkQueryOpenApiV2VO) Get() *LanNetworkQueryOpenApiV2VO {
	return v.value
}

func (v *NullableLanNetworkQueryOpenApiV2VO) Set(val *LanNetworkQueryOpenApiV2VO) {
	v.value = val
	v.isSet = true
}

func (v NullableLanNetworkQueryOpenApiV2VO) IsSet() bool {
	return v.isSet
}

func (v *NullableLanNetworkQueryOpenApiV2VO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLanNetworkQueryOpenApiV2VO(val *LanNetworkQueryOpenApiV2VO) *NullableLanNetworkQueryOpenApiV2VO {
	return &NullableLanNetworkQueryOpenApiV2VO{value: val, isSet: true}
}

func (v NullableLanNetworkQueryOpenApiV2VO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLanNetworkQueryOpenApiV2VO) UnmarshalJSON(src []byte) error {
	v.isSet = true
