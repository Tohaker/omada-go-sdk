...
// checks if the ModifySpeedTestV2SettingOpenApiVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModifySpeedTestV2SettingOpenApiVO{}

// ModifySpeedTestV2SettingOpenApiVO struct for ModifySpeedTestV2SettingOpenApiVO
type ModifySpeedTestV2SettingOpenApiVO struct {
...
type _ModifySpeedTestV2SettingOpenApiVO ModifySpeedTestV2SettingOpenApiVO
...
func NewModifySpeedTestV2SettingOpenApiVO(autoSpeedTest bool) *ModifySpeedTestV2SettingOpenApiVO {
	this := ModifySpeedTestV2SettingOpenApiVO{}
...
func (o ModifySpeedTestV2SettingOpenApiVO) MarshalJSON() ([]byte, error) {
...
func (o ModifySpeedTestV2SettingOpenApiVO) ToMap() (map[string]interface{}, error) {
...
func (o *ModifySpeedTestV2SettingOpenApiVO) UnmarshalJSON(data []byte) (err error) {
	...
	varModifySpeedTestV2SettingOpenApiVO := _ModifySpeedTestV2SettingOpenApiVO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varModifySpeedTestV2SettingOpenApiVO)

	if err != nil {
		return err
	}

	*o = ModifySpeedTestV2SettingOpenApiVO(varModifySpeedTestV2SettingOpenApiVO)

	return err
}

type NullableModifySpeedTestV2SettingOpenApiVO struct {
	value *ModifySpeedTestV2SettingOpenApiVO
	isSet bool
}

func (v NullableModifySpeedTestV2SettingOpenApiVO) Get() *ModifySpeedTestV2SettingOpenApiVO {
	return v.value
}

func (v *NullableModifySpeedTestV2SettingOpenApiVO) Set(val *ModifySpeedTestV2SettingOpenApiVO) {
	v.value = val
	v.isSet = true
}

func (v NullableModifySpeedTestV2SettingOpenApiVO) IsSet() bool {
	return v.isSet
}

func (v *NullableModifySpeedTestV2SettingOpenApiVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModifySpeedTestV2SettingOpenApiVO(val *ModifySpeedTestV2SettingOpenApiVO) *NullableModifySpeedTestV2SettingOpenApiVO {
	return &NullableModifySpeedTestV2SettingOpenApiVO{value: val, isSet: true}
}

func (v NullableModifySpeedTestV2SettingOpenApiVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModifySpeedTestV2SettingOpenApiVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
