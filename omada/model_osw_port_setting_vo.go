...
// checks if the OswPortSettingVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OswPortSettingVO{}

// OswPortSettingVO struct for OswPortSettingVO
type OswPortSettingVO struct {
...
func (o OswPortSettingVO) MarshalJSON() ([]byte, error) {
...
func (o OswPortSettingVO) ToMap() (map[string]interface{}, error) {
...
type NullableOswPortSettingVO struct {
	value *OswPortSettingVO
	isSet bool
}

func (v NullableOswPortSettingVO) Get() *OswPortSettingVO {
	return v.value
}

func (v *NullableOswPortSettingVO) Set(val *OswPortSettingVO) {
	v.value = val
	v.isSet = true
}

func (v NullableOswPortSettingVO) IsSet() bool {
	return v.isSet
}

func (v *NullableOswPortSettingVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOswPortSettingVO(val *OswPortSettingVO) *NullableOswPortSettingVO {
	return &NullableOswPortSettingVO{value: val, isSet: true}
}

func (v NullableOswPortSettingVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOswPortSettingVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
