...
// checks if the GridVOGatewayACLInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVOGatewayACLInfo{}

// GridVOGatewayACLInfo struct for GridVOGatewayACLInfo
type GridVOGatewayACLInfo struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []GatewayACLInfo `json:"data,omitempty"`
...
// SetData gets a reference to the given []GatewayACLInfo and assigns it to the Data field.
...
func (o GridVOGatewayACLInfo) MarshalJSON() ([]byte, error) {
...
func (o GridVOGatewayACLInfo) ToMap() (map[string]interface{}, error) {
...
type NullableGridVOGatewayACLInfo struct {
	value *GridVOGatewayACLInfo
	isSet bool
}

func (v NullableGridVOGatewayACLInfo) Get() *GridVOGatewayACLInfo {
	return v.value
}

func (v *NullableGridVOGatewayACLInfo) Set(val *GridVOGatewayACLInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVOGatewayACLInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVOGatewayACLInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVOGatewayACLInfo(val *GridVOGatewayACLInfo) *NullableGridVOGatewayACLInfo {
	return &NullableGridVOGatewayACLInfo{value: val, isSet: true}
}

func (v NullableGridVOGatewayACLInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVOGatewayACLInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
