...
// checks if the GridVOLanDnsOpenApiVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVOLanDnsOpenApiVO{}

// GridVOLanDnsOpenApiVO struct for GridVOLanDnsOpenApiVO
type GridVOLanDnsOpenApiVO struct {
	// Current page number.
...
func (o GridVOLanDnsOpenApiVO) MarshalJSON() ([]byte, error) {
...
func (o GridVOLanDnsOpenApiVO) ToMap() (map[string]interface{}, error) {
...
type NullableGridVOLanDnsOpenApiVO struct {
	value *GridVOLanDnsOpenApiVO
	isSet bool
}

func (v NullableGridVOLanDnsOpenApiVO) Get() *GridVOLanDnsOpenApiVO {
	return v.value
}

func (v *NullableGridVOLanDnsOpenApiVO) Set(val *GridVOLanDnsOpenApiVO) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVOLanDnsOpenApiVO) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVOLanDnsOpenApiVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVOLanDnsOpenApiVO(val *GridVOLanDnsOpenApiVO) *NullableGridVOLanDnsOpenApiVO {
	return &NullableGridVOLanDnsOpenApiVO{value: val, isSet: true}
}

func (v NullableGridVOLanDnsOpenApiVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVOLanDnsOpenApiVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
