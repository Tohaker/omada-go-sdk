...
// checks if the TopologyClientWirelessUpInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TopologyClientWirelessUpInfo{}
...
func NewTopologyClientWirelessUpInfo() *TopologyClientWirelessUpInfo {
	this := TopologyClientWirelessUpInfo{}
	return &this
}
...
func (o *TopologyClientWirelessUpInfo) GetMultiLink() []TopologyClientWirelessLinkInfo {
	if o == nil || IsNil(o.MultiLink) {
		var ret []TopologyClientWirelessLinkInfo
		return ret
	}
	return o.MultiLink
}
...
// SetMultiLink gets a reference to the given []TopologyClientWirelessLinkInfo and assigns it to the MultiLink field.
...
func (o TopologyClientWirelessUpInfo) MarshalJSON() ([]byte, error) {
...
func (o TopologyClientWirelessUpInfo) ToMap() (map[string]interface{}, error) {
...
type NullableTopologyClientWirelessUpInfo struct {
	value *TopologyClientWirelessUpInfo
	isSet bool
}

func (v NullableTopologyClientWirelessUpInfo) Get() *TopologyClientWirelessUpInfo {
	return v.value
}

func (v *NullableTopologyClientWirelessUpInfo) Set(val *TopologyClientWirelessUpInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableTopologyClientWirelessUpInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableTopologyClientWirelessUpInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTopologyClientWirelessUpInfo(val *TopologyClientWirelessUpInfo) *NullableTopologyClientWirelessUpInfo {
	return &NullableTopologyClientWirelessUpInfo{value: val, isSet: true}
}

func (v NullableTopologyClientWirelessUpInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTopologyClientWirelessUpInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
