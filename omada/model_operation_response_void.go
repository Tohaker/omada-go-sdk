...
// checks if the OperationResponseVoid type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OperationResponseVoid{}

// OperationResponseVoid struct for OperationResponseVoid
...
func (o OperationResponseVoid) MarshalJSON() ([]byte, error) {
...
func (o OperationResponseVoid) ToMap() (map[string]interface{}, error) {
...
type NullableOperationResponseVoid struct {
	value *OperationResponseVoid
	isSet bool
}

func (v NullableOperationResponseVoid) Get() *OperationResponseVoid {
	return v.value
}

func (v *NullableOperationResponseVoid) Set(val *OperationResponseVoid) {
	v.value = val
	v.isSet = true
}

func (v NullableOperationResponseVoid) IsSet() bool {
	return v.isSet
}

func (v *NullableOperationResponseVoid) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOperationResponseVoid(val *OperationResponseVoid) *NullableOperationResponseVoid {
	return &NullableOperationResponseVoid{value: val, isSet: true}
}

func (v NullableOperationResponseVoid) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOperationResponseVoid) UnmarshalJSON(src []byte) error {
	v.isSet = true
