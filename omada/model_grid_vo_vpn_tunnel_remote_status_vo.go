...
// checks if the GridVOVpnTunnelRemoteStatusVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVOVpnTunnelRemoteStatusVO{}

// GridVOVpnTunnelRemoteStatusVO struct for GridVOVpnTunnelRemoteStatusVO
type GridVOVpnTunnelRemoteStatusVO struct {
	// Current page number.
...
func NewGridVOVpnTunnelRemoteStatusVO() *GridVOVpnTunnelRemoteStatusVO {
	this := GridVOVpnTunnelRemoteStatusVO{}
	return &this
}
...
func (o GridVOVpnTunnelRemoteStatusVO) MarshalJSON() ([]byte, error) {
...
func (o GridVOVpnTunnelRemoteStatusVO) ToMap() (map[string]interface{}, error) {
...
type NullableGridVOVpnTunnelRemoteStatusVO struct {
	value *GridVOVpnTunnelRemoteStatusVO
	isSet bool
}

func (v NullableGridVOVpnTunnelRemoteStatusVO) Get() *GridVOVpnTunnelRemoteStatusVO {
	return v.value
}

func (v *NullableGridVOVpnTunnelRemoteStatusVO) Set(val *GridVOVpnTunnelRemoteStatusVO) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVOVpnTunnelRemoteStatusVO) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVOVpnTunnelRemoteStatusVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVOVpnTunnelRemoteStatusVO(val *GridVOVpnTunnelRemoteStatusVO) *NullableGridVOVpnTunnelRemoteStatusVO {
	return &NullableGridVOVpnTunnelRemoteStatusVO{value: val, isSet: true}
}

func (v NullableGridVOVpnTunnelRemoteStatusVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVOVpnTunnelRemoteStatusVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
