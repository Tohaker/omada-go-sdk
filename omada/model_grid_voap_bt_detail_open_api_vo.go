...
// checks if the GridVOApBtDetailOpenApiVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVOApBtDetailOpenApiVO{}

// GridVOApBtDetailOpenApiVO struct for GridVOApBtDetailOpenApiVO
type GridVOApBtDetailOpenApiVO struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []ApBtDetailOpenApiVO `json:"data,omitempty"`
...
func NewGridVOApBtDetailOpenApiVO() *GridVOApBtDetailOpenApiVO {
	this := GridVOApBtDetailOpenApiVO{}
	return &this
}
...
// SetData gets a reference to the given []ApBtDetailOpenApiVO and assigns it to the Data field.
...
func (o GridVOApBtDetailOpenApiVO) MarshalJSON() ([]byte, error) {
...
func (o GridVOApBtDetailOpenApiVO) ToMap() (map[string]interface{}, error) {
...
type NullableGridVOApBtDetailOpenApiVO struct {
	value *GridVOApBtDetailOpenApiVO
	isSet bool
}

func (v NullableGridVOApBtDetailOpenApiVO) Get() *GridVOApBtDetailOpenApiVO {
	return v.value
}

func (v *NullableGridVOApBtDetailOpenApiVO) Set(val *GridVOApBtDetailOpenApiVO) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVOApBtDetailOpenApiVO) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVOApBtDetailOpenApiVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVOApBtDetailOpenApiVO(val *GridVOApBtDetailOpenApiVO) *NullableGridVOApBtDetailOpenApiVO {
	return &NullableGridVOApBtDetailOpenApiVO{value: val, isSet: true}
}

func (v NullableGridVOApBtDetailOpenApiVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVOApBtDetailOpenApiVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
