...
// checks if the GridVORuleEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVORuleEntity{}

// GridVORuleEntity struct for GridVORuleEntity
type GridVORuleEntity struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []RuleEntity `json:"data,omitempty"`
...
// SetData gets a reference to the given []RuleEntity and assigns it to the Data field.
...
func (o GridVORuleEntity) MarshalJSON() ([]byte, error) {
...
func (o GridVORuleEntity) ToMap() (map[string]interface{}, error) {
...
type NullableGridVORuleEntity struct {
	value *GridVORuleEntity
	isSet bool
}

func (v NullableGridVORuleEntity) Get() *GridVORuleEntity {
	return v.value
}

func (v *NullableGridVORuleEntity) Set(val *GridVORuleEntity) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVORuleEntity) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVORuleEntity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVORuleEntity(val *GridVORuleEntity) *NullableGridVORuleEntity {
	return &NullableGridVORuleEntity{value: val, isSet: true}
}

func (v NullableGridVORuleEntity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVORuleEntity) UnmarshalJSON(src []byte) error {
	v.isSet = true
