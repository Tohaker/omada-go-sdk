...
// checks if the PageResponseDBAProfileVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageResponseDBAProfileVO{}

// PageResponseDBAProfileVO struct for PageResponseDBAProfileVO
type PageResponseDBAProfileVO struct {
	// Content
	Content []DBAProfileVO `json:"content,omitempty"`
...
// SetContent gets a reference to the given []DBAProfileVO and assigns it to the Content field.
...
func (o PageResponseDBAProfileVO) MarshalJSON() ([]byte, error) {
...
func (o PageResponseDBAProfileVO) ToMap() (map[string]interface{}, error) {
...
type NullablePageResponseDBAProfileVO struct {
	value *PageResponseDBAProfileVO
	isSet bool
}

func (v NullablePageResponseDBAProfileVO) Get() *PageResponseDBAProfileVO {
	return v.value
}

func (v *NullablePageResponseDBAProfileVO) Set(val *PageResponseDBAProfileVO) {
	v.value = val
	v.isSet = true
}

func (v NullablePageResponseDBAProfileVO) IsSet() bool {
	return v.isSet
}

func (v *NullablePageResponseDBAProfileVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageResponseDBAProfileVO(val *PageResponseDBAProfileVO) *NullablePageResponseDBAProfileVO {
	return &NullablePageResponseDBAProfileVO{value: val, isSet: true}
}

func (v NullablePageResponseDBAProfileVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageResponseDBAProfileVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
