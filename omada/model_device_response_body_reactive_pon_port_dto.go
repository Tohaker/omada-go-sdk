...
// checks if the DeviceResponseBodyReactivePonPortDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceResponseBodyReactivePonPortDTO{}

// DeviceResponseBodyReactivePonPortDTO struct for DeviceResponseBodyReactivePonPortDTO
type DeviceResponseBodyReactivePonPortDTO struct {
	Data *ReactivePonPortDTO `json:"data,omitempty"`
...
func NewDeviceResponseBodyReactivePonPortDTO() *DeviceResponseBodyReactivePonPortDTO {
	this := DeviceResponseBodyReactivePonPortDTO{}
	return &this
}
...
// SetData gets a reference to the given ReactivePonPortDTO and assigns it to the Data field.
...
func (o DeviceResponseBodyReactivePonPortDTO) MarshalJSON() ([]byte, error) {
...
func (o DeviceResponseBodyReactivePonPortDTO) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceResponseBodyReactivePonPortDTO struct {
	value *DeviceResponseBodyReactivePonPortDTO
	isSet bool
}

func (v NullableDeviceResponseBodyReactivePonPortDTO) Get() *DeviceResponseBodyReactivePonPortDTO {
	return v.value
}

func (v *NullableDeviceResponseBodyReactivePonPortDTO) Set(val *DeviceResponseBodyReactivePonPortDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceResponseBodyReactivePonPortDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceResponseBodyReactivePonPortDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceResponseBodyReactivePonPortDTO(val *DeviceResponseBodyReactivePonPortDTO) *NullableDeviceResponseBodyReactivePonPortDTO {
	return &NullableDeviceResponseBodyReactivePonPortDTO{value: val, isSet: true}
}

func (v NullableDeviceResponseBodyReactivePonPortDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceResponseBodyReactivePonPortDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
