...
// checks if the GridVOUserDetailVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVOUserDetailVO{}

// GridVOUserDetailVO struct for GridVOUserDetailVO
...
// SetData gets a reference to the given []UserDetailVO and assigns it to the Data field.
...
func (o GridVOUserDetailVO) MarshalJSON() ([]byte, error) {
...
func (o GridVOUserDetailVO) ToMap() (map[string]interface{}, error) {
...
type NullableGridVOUserDetailVO struct {
	value *GridVOUserDetailVO
	isSet bool
}

func (v NullableGridVOUserDetailVO) Get() *GridVOUserDetailVO {
	return v.value
}

func (v *NullableGridVOUserDetailVO) Set(val *GridVOUserDetailVO) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVOUserDetailVO) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVOUserDetailVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVOUserDetailVO(val *GridVOUserDetailVO) *NullableGridVOUserDetailVO {
	return &NullableGridVOUserDetailVO{value: val, isSet: true}
}

func (v NullableGridVOUserDetailVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVOUserDetailVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
