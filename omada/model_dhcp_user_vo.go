...
// checks if the DhcpUserVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpUserVO{}

// DhcpUserVO struct for DhcpUserVO
type DhcpUserVO struct {
	// IP Address
...
func (o DhcpUserVO) MarshalJSON() ([]byte, error) {
...
func (o DhcpUserVO) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpUserVO struct {
	value *DhcpUserVO
	isSet bool
}

func (v NullableDhcpUserVO) Get() *DhcpUserVO {
	return v.value
}

func (v *NullableDhcpUserVO) Set(val *DhcpUserVO) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpUserVO) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpUserVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpUserVO(val *DhcpUserVO) *NullableDhcpUserVO {
	return &NullableDhcpUserVO{value: val, isSet: true}
}

func (v NullableDhcpUserVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpUserVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
