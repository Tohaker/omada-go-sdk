...
// checks if the GridVOVpnTunnelStatusVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVOVpnTunnelStatusVO{}

// GridVOVpnTunnelStatusVO struct for GridVOVpnTunnelStatusVO
type GridVOVpnTunnelStatusVO struct {
	// Current page number.
...
func (o GridVOVpnTunnelStatusVO) MarshalJSON() ([]byte, error) {
...
func (o GridVOVpnTunnelStatusVO) ToMap() (map[string]interface{}, error) {
...
type NullableGridVOVpnTunnelStatusVO struct {
	value *GridVOVpnTunnelStatusVO
	isSet bool
}

func (v NullableGridVOVpnTunnelStatusVO) Get() *GridVOVpnTunnelStatusVO {
	return v.value
}

func (v *NullableGridVOVpnTunnelStatusVO) Set(val *GridVOVpnTunnelStatusVO) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVOVpnTunnelStatusVO) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVOVpnTunnelStatusVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVOVpnTunnelStatusVO(val *GridVOVpnTunnelStatusVO) *NullableGridVOVpnTunnelStatusVO {
	return &NullableGridVOVpnTunnelStatusVO{value: val, isSet: true}
}

func (v NullableGridVOVpnTunnelStatusVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVOVpnTunnelStatusVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
