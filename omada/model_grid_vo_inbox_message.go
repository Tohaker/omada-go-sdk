...
// checks if the GridVOInboxMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVOInboxMessage{}

// GridVOInboxMessage struct for GridVOInboxMessage
type GridVOInboxMessage struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []InboxMessage `json:"data,omitempty"`
...
// SetData gets a reference to the given []InboxMessage and assigns it to the Data field.
...
func (o GridVOInboxMessage) MarshalJSON() ([]byte, error) {
...
func (o GridVOInboxMessage) ToMap() (map[string]interface{}, error) {
...
type NullableGridVOInboxMessage struct {
	value *GridVOInboxMessage
	isSet bool
}

func (v NullableGridVOInboxMessage) Get() *GridVOInboxMessage {
	return v.value
}

func (v *NullableGridVOInboxMessage) Set(val *GridVOInboxMessage) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVOInboxMessage) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVOInboxMessage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVOInboxMessage(val *GridVOInboxMessage) *NullableGridVOInboxMessage {
	return &NullableGridVOInboxMessage{value: val, isSet: true}
}

func (v NullableGridVOInboxMessage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVOInboxMessage) UnmarshalJSON(src []byte) error {
	v.isSet = true
