...
// checks if the LanDnsGridVOLanDnsQueryOpenApiVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LanDnsGridVOLanDnsQueryOpenApiVO{}

// LanDnsGridVOLanDnsQueryOpenApiVO struct for LanDnsGridVOLanDnsQueryOpenApiVO
type LanDnsGridVOLanDnsQueryOpenApiVO struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []LanDnsQueryOpenApiVO `json:"data,omitempty"`
...
func NewLanDnsGridVOLanDnsQueryOpenApiVO() *LanDnsGridVOLanDnsQueryOpenApiVO {
	this := LanDnsGridVOLanDnsQueryOpenApiVO{}
	return &this
}
...
// SetData gets a reference to the given []LanDnsQueryOpenApiVO and assigns it to the Data field.
...
func (o LanDnsGridVOLanDnsQueryOpenApiVO) MarshalJSON() ([]byte, error) {
...
func (o LanDnsGridVOLanDnsQueryOpenApiVO) ToMap() (map[string]interface{}, error) {
...
type NullableLanDnsGridVOLanDnsQueryOpenApiVO struct {
	value *LanDnsGridVOLanDnsQueryOpenApiVO
	isSet bool
}

func (v NullableLanDnsGridVOLanDnsQueryOpenApiVO) Get() *LanDnsGridVOLanDnsQueryOpenApiVO {
	return v.value
}

func (v *NullableLanDnsGridVOLanDnsQueryOpenApiVO) Set(val *LanDnsGridVOLanDnsQueryOpenApiVO) {
	v.value = val
	v.isSet = true
}

func (v NullableLanDnsGridVOLanDnsQueryOpenApiVO) IsSet() bool {
	return v.isSet
}

func (v *NullableLanDnsGridVOLanDnsQueryOpenApiVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLanDnsGridVOLanDnsQueryOpenApiVO(val *LanDnsGridVOLanDnsQueryOpenApiVO) *NullableLanDnsGridVOLanDnsQueryOpenApiVO {
	return &NullableLanDnsGridVOLanDnsQueryOpenApiVO{value: val, isSet: true}
}

func (v NullableLanDnsGridVOLanDnsQueryOpenApiVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLanDnsGridVOLanDnsQueryOpenApiVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
