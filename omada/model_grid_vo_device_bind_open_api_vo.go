...
// checks if the GridVODeviceBindOpenApiVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVODeviceBindOpenApiVO{}

// GridVODeviceBindOpenApiVO struct for GridVODeviceBindOpenApiVO
type GridVODeviceBindOpenApiVO struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []DeviceBindOpenApiVO `json:"data,omitempty"`
...
func NewGridVODeviceBindOpenApiVO() *GridVODeviceBindOpenApiVO {
	this := GridVODeviceBindOpenApiVO{}
	return &this
}
...
// SetData gets a reference to the given []DeviceBindOpenApiVO and assigns it to the Data field.
...
func (o GridVODeviceBindOpenApiVO) MarshalJSON() ([]byte, error) {
...
func (o GridVODeviceBindOpenApiVO) ToMap() (map[string]interface{}, error) {
...
type NullableGridVODeviceBindOpenApiVO struct {
	value *GridVODeviceBindOpenApiVO
	isSet bool
}

func (v NullableGridVODeviceBindOpenApiVO) Get() *GridVODeviceBindOpenApiVO {
	return v.value
}

func (v *NullableGridVODeviceBindOpenApiVO) Set(val *GridVODeviceBindOpenApiVO) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVODeviceBindOpenApiVO) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVODeviceBindOpenApiVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVODeviceBindOpenApiVO(val *GridVODeviceBindOpenApiVO) *NullableGridVODeviceBindOpenApiVO {
	return &NullableGridVODeviceBindOpenApiVO{value: val, isSet: true}
}

func (v NullableGridVODeviceBindOpenApiVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVODeviceBindOpenApiVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
