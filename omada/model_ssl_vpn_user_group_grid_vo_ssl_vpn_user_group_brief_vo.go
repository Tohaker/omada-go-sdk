...
// checks if the SslVpnUserGroupGridVOSslVpnUserGroupBriefVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SslVpnUserGroupGridVOSslVpnUserGroupBriefVO{}

// SslVpnUserGroupGridVOSslVpnUserGroupBriefVO struct for SslVpnUserGroupGridVOSslVpnUserGroupBriefVO
type SslVpnUserGroupGridVOSslVpnUserGroupBriefVO struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []SslVpnUserGroupBriefVO `json:"data,omitempty"`
...
func NewSslVpnUserGroupGridVOSslVpnUserGroupBriefVO() *SslVpnUserGroupGridVOSslVpnUserGroupBriefVO {
	this := SslVpnUserGroupGridVOSslVpnUserGroupBriefVO{}
	return &this
}
...
// SetData gets a reference to the given []SslVpnUserGroupBriefVO and assigns it to the Data field.
...
func (o SslVpnUserGroupGridVOSslVpnUserGroupBriefVO) MarshalJSON() ([]byte, error) {
...
func (o SslVpnUserGroupGridVOSslVpnUserGroupBriefVO) ToMap() (map[string]interface{}, error) {
...
type NullableSslVpnUserGroupGridVOSslVpnUserGroupBriefVO struct {
	value *SslVpnUserGroupGridVOSslVpnUserGroupBriefVO
	isSet bool
}

func (v NullableSslVpnUserGroupGridVOSslVpnUserGroupBriefVO) Get() *SslVpnUserGroupGridVOSslVpnUserGroupBriefVO {
	return v.value
}

func (v *NullableSslVpnUserGroupGridVOSslVpnUserGroupBriefVO) Set(val *SslVpnUserGroupGridVOSslVpnUserGroupBriefVO) {
	v.value = val
	v.isSet = true
}

func (v NullableSslVpnUserGroupGridVOSslVpnUserGroupBriefVO) IsSet() bool {
	return v.isSet
}

func (v *NullableSslVpnUserGroupGridVOSslVpnUserGroupBriefVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSslVpnUserGroupGridVOSslVpnUserGroupBriefVO(val *SslVpnUserGroupGridVOSslVpnUserGroupBriefVO) *NullableSslVpnUserGroupGridVOSslVpnUserGroupBriefVO {
	return &NullableSslVpnUserGroupGridVOSslVpnUserGroupBriefVO{value: val, isSet: true}
}

func (v NullableSslVpnUserGroupGridVOSslVpnUserGroupBriefVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSslVpnUserGroupGridVOSslVpnUserGroupBriefVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
