...
// checks if the PageResponseServicePortVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageResponseServicePortVO{}

// PageResponseServicePortVO struct for PageResponseServicePortVO
type PageResponseServicePortVO struct {
	// Content
	Content []ServicePortVO `json:"content,omitempty"`
...
func NewPageResponseServicePortVO() *PageResponseServicePortVO {
	this := PageResponseServicePortVO{}
	return &this
}
...
// SetContent gets a reference to the given []ServicePortVO and assigns it to the Content field.
...
func (o PageResponseServicePortVO) MarshalJSON() ([]byte, error) {
...
func (o PageResponseServicePortVO) ToMap() (map[string]interface{}, error) {
...
type NullablePageResponseServicePortVO struct {
	value *PageResponseServicePortVO
	isSet bool
}

func (v NullablePageResponseServicePortVO) Get() *PageResponseServicePortVO {
	return v.value
}

func (v *NullablePageResponseServicePortVO) Set(val *PageResponseServicePortVO) {
	v.value = val
	v.isSet = true
}

func (v NullablePageResponseServicePortVO) IsSet() bool {
	return v.isSet
}

func (v *NullablePageResponseServicePortVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageResponseServicePortVO(val *PageResponseServicePortVO) *NullablePageResponseServicePortVO {
	return &NullablePageResponseServicePortVO{value: val, isSet: true}
}

func (v NullablePageResponseServicePortVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageResponseServicePortVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
