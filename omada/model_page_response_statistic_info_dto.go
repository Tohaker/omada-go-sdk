...
// checks if the PageResponseStatisticInfoDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageResponseStatisticInfoDTO{}

// PageResponseStatisticInfoDTO struct for PageResponseStatisticInfoDTO
type PageResponseStatisticInfoDTO struct {
	// Content
	Content []StatisticInfoDTO `json:"content,omitempty"`
...
func NewPageResponseStatisticInfoDTO() *PageResponseStatisticInfoDTO {
	this := PageResponseStatisticInfoDTO{}
	return &this
}
...
// SetContent gets a reference to the given []StatisticInfoDTO and assigns it to the Content field.
...
func (o PageResponseStatisticInfoDTO) MarshalJSON() ([]byte, error) {
...
func (o PageResponseStatisticInfoDTO) ToMap() (map[string]interface{}, error) {
...
type NullablePageResponseStatisticInfoDTO struct {
	value *PageResponseStatisticInfoDTO
	isSet bool
}

func (v NullablePageResponseStatisticInfoDTO) Get() *PageResponseStatisticInfoDTO {
	return v.value
}

func (v *NullablePageResponseStatisticInfoDTO) Set(val *PageResponseStatisticInfoDTO) {
	v.value = val
	v.isSet = true
}

func (v NullablePageResponseStatisticInfoDTO) IsSet() bool {
	return v.isSet
}

func (v *NullablePageResponseStatisticInfoDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageResponseStatisticInfoDTO(val *PageResponseStatisticInfoDTO) *NullablePageResponseStatisticInfoDTO {
	return &NullablePageResponseStatisticInfoDTO{value: val, isSet: true}
}

func (v NullablePageResponseStatisticInfoDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageResponseStatisticInfoDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
