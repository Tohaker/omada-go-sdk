...
// checks if the PageResponseAuthenticationConfigDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageResponseAuthenticationConfigDTO{}

// PageResponseAuthenticationConfigDTO struct for PageResponseAuthenticationConfigDTO
type PageResponseAuthenticationConfigDTO struct {
	// Content
	Content []AuthenticationConfigDTO `json:"content,omitempty"`
...
func NewPageResponseAuthenticationConfigDTO() *PageResponseAuthenticationConfigDTO {
	this := PageResponseAuthenticationConfigDTO{}
	return &this
}
...
// SetContent gets a reference to the given []AuthenticationConfigDTO and assigns it to the Content field.
...
func (o PageResponseAuthenticationConfigDTO) MarshalJSON() ([]byte, error) {
...
func (o PageResponseAuthenticationConfigDTO) ToMap() (map[string]interface{}, error) {
...
type NullablePageResponseAuthenticationConfigDTO struct {
	value *PageResponseAuthenticationConfigDTO
	isSet bool
}

func (v NullablePageResponseAuthenticationConfigDTO) Get() *PageResponseAuthenticationConfigDTO {
	return v.value
}

func (v *NullablePageResponseAuthenticationConfigDTO) Set(val *PageResponseAuthenticationConfigDTO) {
	v.value = val
	v.isSet = true
}

func (v NullablePageResponseAuthenticationConfigDTO) IsSet() bool {
	return v.isSet
}

func (v *NullablePageResponseAuthenticationConfigDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageResponseAuthenticationConfigDTO(val *PageResponseAuthenticationConfigDTO) *NullablePageResponseAuthenticationConfigDTO {
	return &NullablePageResponseAuthenticationConfigDTO{value: val, isSet: true}
}

func (v NullablePageResponseAuthenticationConfigDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageResponseAuthenticationConfigDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
