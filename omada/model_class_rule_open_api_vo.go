...
// checks if the ClassRuleOpenApiVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClassRuleOpenApiVO{}

// ClassRuleOpenApiVO struct for ClassRuleOpenApiVO
type ClassRuleOpenApiVO struct {
...
type _ClassRuleOpenApiVO ClassRuleOpenApiVO
...
func (o ClassRuleOpenApiVO) MarshalJSON() ([]byte, error) {
...
func (o ClassRuleOpenApiVO) ToMap() (map[string]interface{}, error) {
...
func (o *ClassRuleOpenApiVO) UnmarshalJSON(data []byte) (err error) {
	...
	varClassRuleOpenApiVO := _ClassRuleOpenApiVO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varClassRuleOpenApiVO)

	if err != nil {
		return err
	}

	*o = ClassRuleOpenApiVO(varClassRuleOpenApiVO)

	return err
}

type NullableClassRuleOpenApiVO struct {
	value *ClassRuleOpenApiVO
	isSet bool
}

func (v NullableClassRuleOpenApiVO) Get() *ClassRuleOpenApiVO {
	return v.value
}

func (v *NullableClassRuleOpenApiVO) Set(val *ClassRuleOpenApiVO) {
	v.value = val
	v.isSet = true
}

func (v NullableClassRuleOpenApiVO) IsSet() bool {
	return v.isSet
}

func (v *NullableClassRuleOpenApiVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClassRuleOpenApiVO(val *ClassRuleOpenApiVO) *NullableClassRuleOpenApiVO {
	return &NullableClassRuleOpenApiVO{value: val, isSet: true}
}

func (v NullableClassRuleOpenApiVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClassRuleOpenApiVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
