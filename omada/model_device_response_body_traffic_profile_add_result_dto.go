...
// checks if the DeviceResponseBodyTrafficProfileAddResultDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceResponseBodyTrafficProfileAddResultDTO{}

// DeviceResponseBodyTrafficProfileAddResultDTO struct for DeviceResponseBodyTrafficProfileAddResultDTO
type DeviceResponseBodyTrafficProfileAddResultDTO struct {
	Data *TrafficProfileAddResultDTO `json:"data,omitempty"`
...
func NewDeviceResponseBodyTrafficProfileAddResultDTO() *DeviceResponseBodyTrafficProfileAddResultDTO {
	this := DeviceResponseBodyTrafficProfileAddResultDTO{}
	return &this
}
...
func (o *DeviceResponseBodyTrafficProfileAddResultDTO) GetData() TrafficProfileAddResultDTO {
	if o == nil || IsNil(o.Data) {
		var ret TrafficProfileAddResultDTO
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given TrafficProfileAddResultDTO and assigns it to the Data field.
...
func (o DeviceResponseBodyTrafficProfileAddResultDTO) MarshalJSON() ([]byte, error) {
...
func (o DeviceResponseBodyTrafficProfileAddResultDTO) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceResponseBodyTrafficProfileAddResultDTO struct {
	value *DeviceResponseBodyTrafficProfileAddResultDTO
	isSet bool
}

func (v NullableDeviceResponseBodyTrafficProfileAddResultDTO) Get() *DeviceResponseBodyTrafficProfileAddResultDTO {
	return v.value
}

func (v *NullableDeviceResponseBodyTrafficProfileAddResultDTO) Set(val *DeviceResponseBodyTrafficProfileAddResultDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceResponseBodyTrafficProfileAddResultDTO) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceResponseBodyTrafficProfileAddResultDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceResponseBodyTrafficProfileAddResultDTO(val *DeviceResponseBodyTrafficProfileAddResultDTO) *NullableDeviceResponseBodyTrafficProfileAddResultDTO {
	return &NullableDeviceResponseBodyTrafficProfileAddResultDTO{value: val, isSet: true}
}

func (v NullableDeviceResponseBodyTrafficProfileAddResultDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceResponseBodyTrafficProfileAddResultDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
