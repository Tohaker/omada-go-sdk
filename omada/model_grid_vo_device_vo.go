...
// checks if the GridVODeviceVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridVODeviceVO{}

// GridVODeviceVO struct for GridVODeviceVO
type GridVODeviceVO struct {
	// Current page number.
	CurrentPage *int32 `json:"currentPage,omitempty"`
	// Number of entries per page.
	CurrentSize *int32 `json:"currentSize,omitempty"`
	Data []DeviceVO `json:"data,omitempty"`
...
// SetData gets a reference to the given []DeviceVO and assigns it to the Data field.
...
func (o GridVODeviceVO) MarshalJSON() ([]byte, error) {
...
func (o GridVODeviceVO) ToMap() (map[string]interface{}, error) {
...
type NullableGridVODeviceVO struct {
	value *GridVODeviceVO
	isSet bool
}

func (v NullableGridVODeviceVO) Get() *GridVODeviceVO {
	return v.value
}

func (v *NullableGridVODeviceVO) Set(val *GridVODeviceVO) {
	v.value = val
	v.isSet = true
}

func (v NullableGridVODeviceVO) IsSet() bool {
	return v.isSet
}

func (v *NullableGridVODeviceVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridVODeviceVO(val *GridVODeviceVO) *NullableGridVODeviceVO {
	return &NullableGridVODeviceVO{value: val, isSet: true}
}

func (v NullableGridVODeviceVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridVODeviceVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
