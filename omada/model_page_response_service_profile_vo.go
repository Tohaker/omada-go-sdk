...
// checks if the PageResponseServiceProfileVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageResponseServiceProfileVO{}

// PageResponseServiceProfileVO struct for PageResponseServiceProfileVO
type PageResponseServiceProfileVO struct {
	// Content
	Content []ServiceProfileVO `json:"content,omitempty"`
...
func NewPageResponseServiceProfileVO() *PageResponseServiceProfileVO {
	this := PageResponseServiceProfileVO{}
	return &this
}
...
// SetContent gets a reference to the given []ServiceProfileVO and assigns it to the Content field.
...
func (o PageResponseServiceProfileVO) MarshalJSON() ([]byte, error) {
...
func (o PageResponseServiceProfileVO) ToMap() (map[string]interface{}, error) {
...
type NullablePageResponseServiceProfileVO struct {
	value *PageResponseServiceProfileVO
	isSet bool
}

func (v NullablePageResponseServiceProfileVO) Get() *PageResponseServiceProfileVO {
	return v.value
}

func (v *NullablePageResponseServiceProfileVO) Set(val *PageResponseServiceProfileVO) {
	v.value = val
	v.isSet = true
}

func (v NullablePageResponseServiceProfileVO) IsSet() bool {
	return v.isSet
}

func (v *NullablePageResponseServiceProfileVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageResponseServiceProfileVO(val *PageResponseServiceProfileVO) *NullablePageResponseServiceProfileVO {
	return &NullablePageResponseServiceProfileVO{value: val, isSet: true}
}

func (v NullablePageResponseServiceProfileVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageResponseServiceProfileVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
