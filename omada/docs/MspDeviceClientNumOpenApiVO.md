...
GetClientNum2gOk returns a tuple with the ClientNum2g field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
GetClientNum5gOk returns a tuple with the ClientNum5g field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
GetClientNum5g2Ok returns a tuple with the ClientNum5g2 field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
GetClientNum6gOk returns a tuple with the ClientNum6g field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
