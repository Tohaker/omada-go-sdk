...
`func (o *GatewayTemplatePortSettingConfig) GetTagSet() []string`

GetTagSet returns the TagSet field if non-nil, zero value otherwise.

### GetTagSetOk

`func (o *GatewayTemplatePortSettingConfig) GetTagSetOk() (*[]string, bool)`
...
`func (o *GatewayTemplatePortSettingConfig) SetTagSet(v []string)`

SetTagSet sets TagSet field to given value.

### HasTagSet

`func (o *GatewayTemplatePortSettingConfig) HasTagSet() bool`
