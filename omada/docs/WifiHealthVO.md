...
GetAccessCapacityScoreOk returns a tuple with the AccessCapacityScore field if it's non-nil, zero value otherwise
...
GetAccessTimeScoreOk returns a tuple with the AccessTimeScore field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
GetChannelInterUtilScoreOk returns a tuple with the ChannelInterUtilScore field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
GetChannelUtilScoreOk returns a tuple with the ChannelUtilScore field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
GetRssiScoreOk returns a tuple with the RssiScore field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
