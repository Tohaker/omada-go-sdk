...
**ClientRatesRequire6g** | Pointer to **bool** | Whether to require clients to use rates at or above the specified value of 6GHz Data Rate Control. | [optional] 
...
**HigherDensity6g** | Pointer to **int32** | 6GHz Data Rate Control higher density value(Unit: Mbps); It should be a value as follows: [54]. | [optional] 
...
**LowerDensity6g** | Pointer to **int32** | 6GHz Data Rate Control lower density value(Unit: Mbps); It should be a value as follows: [6, 9, 12, 18, 24, 36, 48, 54]. | [optional] 
...
**ManageRateControl2gEnable** | Pointer to **bool** | Whether to enable 2.4GHz Manage Rate Control. | [optional] 
...
**Rate2gCtrlEnable** | Pointer to **bool** | Whether to enable 2.4GHz Data Rate Control | [optional] 
**Rate5gCtrlEnable** | Pointer to **bool** | Whether to enable 5GHz Data Rate Control. | [optional] 
**Rate6gCtrlEnable** | Pointer to **bool** | Whether to enable 6GHz Data Rate Control. | [optional] 
...
**SendBeacons6g** | Pointer to **bool** | Whether to enable send beacons at 6Mbps of 6GHz Data Rate Control. | [optional] 

## Methods

### NewSsidRateControlOpenApiVO
...
### NewSsidRateControlOpenApiVOWithDefaults
