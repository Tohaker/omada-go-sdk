...
**TimeEnable** | Pointer to **bool** | Parameter [timeEnable] can be TRUE only when [mode] &#x3D; 1. Power Saving trigger by time config status. True: enable, false: disable. | [optional] 
