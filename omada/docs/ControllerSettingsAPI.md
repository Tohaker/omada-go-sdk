...
> OperationResponseRadiusProxyServerSetting GetRadiusProxy(ctx, omadacId).Execute()

Get RADIUS proxy server setting
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ControllerSettingsAPI.GetRadiusProxy(context.Background(), omadacId).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ControllerSettingsAPI.GetRadiusProxy``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetRadiusProxy`: OperationResponseRadiusProxyServerSetting
	fmt.Fprintf(os.Stdout, "Response from `ControllerSettingsAPI.GetRadiusProxy`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetRadiusProxyRequest struct via the builder pattern
...
> OperationResponseBuiltInRadiusServerSetting GetRadiusServer(ctx, omadacId).Execute()

Get Built-In RADIUS server setting
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ControllerSettingsAPI.GetRadiusServer(context.Background(), omadacId).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ControllerSettingsAPI.GetRadiusServer``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetRadiusServer`: OperationResponseBuiltInRadiusServerSetting
	fmt.Fprintf(os.Stdout, "Response from `ControllerSettingsAPI.GetRadiusServer`: %v\n", resp)
}
```
...
> OperationResponseRadiusProxyServerSetting ModifyRadiusProxy(ctx, omadacId).RadiusProxyServerSetting(radiusProxyServerSetting).Execute()

Modify RADIUS proxy server setting
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ControllerSettingsAPI.ModifyRadiusProxy(context.Background(), omadacId).RadiusProxyServerSetting(radiusProxyServerSetting).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ControllerSettingsAPI.ModifyRadiusProxy``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `ModifyRadiusProxy`: OperationResponseRadiusProxyServerSetting
	fmt.Fprintf(os.Stdout, "Response from `ControllerSettingsAPI.ModifyRadiusProxy`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiModifyRadiusProxyRequest struct via the builder pattern
...
> OperationResponse ModifyRadiusServer(ctx, omadacId).BuiltInRadiusServerSetting(builtInRadiusServerSetting).Execute()

Modify Built-In RADIUS server setting
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ControllerSettingsAPI.ModifyRadiusServer(context.Background(), omadacId).BuiltInRadiusServerSetting(builtInRadiusServerSetting).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ControllerSettingsAPI.ModifyRadiusServer``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `ModifyRadiusServer`: OperationResponse
	fmt.Fprintf(os.Stdout, "Response from `ControllerSettingsAPI.ModifyRadiusServer`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiModifyRadiusServerRequest struct via the builder pattern
