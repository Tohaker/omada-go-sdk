...
**PortMappingType** | Pointer to **string** | The mapping relationship between Gem Port and ONT Port ID is valid when the Line Profile&#39;s mappingMode is set to: Port, Port-Vlan, Port-Priority, or Port-Vlan-Priority. PortMappingType should be a value as follows: ETH, with the default value being ETH. | [optional] 
...
### NewGemMappingModifyDTO

`func NewGemMappingModifyDTO(gemMappingId int32, gemPortId int32, ) *GemMappingModifyDTO`

NewGemMappingModifyDTO instantiates a new GemMappingModifyDTO object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewGemMappingModifyDTOWithDefaults

`func NewGemMappingModifyDTOWithDefaults() *GemMappingModifyDTO`

NewGemMappingModifyDTOWithDefaults instantiates a new GemMappingModifyDTO object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetGemMappingId

`func (o *GemMappingModifyDTO) GetGemMappingId() int32`

GetGemMappingId returns the GemMappingId field if non-nil, zero value otherwise.

### GetGemMappingIdOk

`func (o *GemMappingModifyDTO) GetGemMappingIdOk() (*int32, bool)`
...
`func (o *GemMappingModifyDTO) SetGemMappingId(v int32)`
...
`func (o *GemMappingModifyDTO) GetGemPortId() int32`

GetGemPortId returns the GemPortId field if non-nil, zero value otherwise.

### GetGemPortIdOk

`func (o *GemMappingModifyDTO) GetGemPortIdOk() (*int32, bool)`
...
`func (o *GemMappingModifyDTO) SetGemPortId(v int32)`
...
`func (o *GemMappingModifyDTO) GetLineProfileId() int32`

GetLineProfileId returns the LineProfileId field if non-nil, zero value otherwise.

### GetLineProfileIdOk

`func (o *GemMappingModifyDTO) GetLineProfileIdOk() (*int32, bool)`
...
`func (o *GemMappingModifyDTO) SetLineProfileId(v int32)`

SetLineProfileId sets LineProfileId field to given value.

### HasLineProfileId

`func (o *GemMappingModifyDTO) HasLineProfileId() bool`

HasLineProfileId returns a boolean if a field has been set.

### GetPortId

`func (o *GemMappingModifyDTO) GetPortId() int32`

GetPortId returns the PortId field if non-nil, zero value otherwise.

### GetPortIdOk

`func (o *GemMappingModifyDTO) GetPortIdOk() (*int32, bool)`
...
`func (o *GemMappingModifyDTO) SetPortId(v int32)`

SetPortId sets PortId field to given value.

### HasPortId

`func (o *GemMappingModifyDTO) HasPortId() bool`

HasPortId returns a boolean if a field has been set.

### GetPortMappingType

`func (o *GemMappingModifyDTO) GetPortMappingType() string`

GetPortMappingType returns the PortMappingType field if non-nil, zero value otherwise.

### GetPortMappingTypeOk

`func (o *GemMappingModifyDTO) GetPortMappingTypeOk() (*string, bool)`
...
`func (o *GemMappingModifyDTO) SetPortMappingType(v string)`

SetPortMappingType sets PortMappingType field to given value.

### HasPortMappingType

`func (o *GemMappingModifyDTO) HasPortMappingType() bool`

HasPortMappingType returns a boolean if a field has been set.

### GetPriority

`func (o *GemMappingModifyDTO) GetPriority() int32`

GetPriority returns the Priority field if non-nil, zero value otherwise.

### GetPriorityOk

`func (o *GemMappingModifyDTO) GetPriorityOk() (*int32, bool)`
...
`func (o *GemMappingModifyDTO) SetPriority(v int32)`

SetPriority sets Priority field to given value.

### HasPriority

`func (o *GemMappingModifyDTO) HasPriority() bool`

HasPriority returns a boolean if a field has been set.

### GetVlanId

`func (o *GemMappingModifyDTO) GetVlanId() int32`

GetVlanId returns the VlanId field if non-nil, zero value otherwise.

### GetVlanIdOk

`func (o *GemMappingModifyDTO) GetVlanIdOk() (*int32, bool)`
...
`func (o *GemMappingModifyDTO) SetVlanId(v int32)`

SetVlanId sets VlanId field to given value.

### HasVlanId

`func (o *GemMappingModifyDTO) HasVlanId() bool`

HasVlanId returns a boolean if a field has been set.

### GetVlanType

`func (o *GemMappingModifyDTO) GetVlanType() string`

GetVlanType returns the VlanType field if non-nil, zero value otherwise.

### GetVlanTypeOk

`func (o *GemMappingModifyDTO) GetVlanTypeOk() (*string, bool)`
...
`func (o *GemMappingModifyDTO) SetVlanType(v string)`

SetVlanType sets VlanType field to given value.

### HasVlanType

`func (o *GemMappingModifyDTO) HasVlanType() bool`
