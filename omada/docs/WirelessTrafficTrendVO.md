...
GetWiredCountOk returns a tuple with the WiredCount field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
GetWirelessCountOk returns a tuple with the WirelessCount field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
